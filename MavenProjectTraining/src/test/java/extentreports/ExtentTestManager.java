...
//import com.aventstack.extentreports.media.entitybuilder.MediaEntityBuilder;
...
//	                + ((TakesScreenshot) ExtentTestManager.getDriver()).getScreenshotAs(OutputType.BASE64);
